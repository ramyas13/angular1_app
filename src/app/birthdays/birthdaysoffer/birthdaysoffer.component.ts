...
import * as wm from '../birthday.json';


@Component({
  selector: 'app-birthdaysoffer',
  templateUrl: './birthdaysoffer.component.html',
  styleUrls: ['./birthdaysoffer.component.css']
})
export class BirthdaysofferComponent implements OnInit {
